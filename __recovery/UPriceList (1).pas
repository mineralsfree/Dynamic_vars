 ...
 type
  ...
  implementation
   ...
   begin
     ...
     temp.INF.productPrice:=StrToCurr(InputBox('Enter price for 1 unit','Price: ',inttostr(1000)));
  ...
  begin
    ...
    begin
      case Fieldnum of
        ...
        2:temp.INF.productPrice:=StrToInt(InputBox('Input changes','Input changes',CurrToStr(temp.INF.productPrice)));
      end;
    end;
    temp:=temp^.ADR
  end;
